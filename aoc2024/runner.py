...
def generate_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="aoc2024",
        description="Advent of Code: 2024 (@dhennessy)",
        epilog="Ho Ho Ho!",
    ...
    parser.add_argument(
        "--redact", default=False, action="store_true", help="Redact the solution values."
    )
    parser.add_argument(
...
def run() -> None:
    ...
    table = Table(title="Advent of Code: 2024 (@dhennessy)", row_styles=["", "dim"])
